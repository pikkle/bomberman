...
public class ElementRenderer implements ElementVisitor
{
	...
	public void visit(Wall wall) {
		if(!rendered.containsKey(wall.getUuid()))
			rendered.put(wall.getUuid(), new ImageViewPane(new ImageView(new Image("ch/heigvd/bomberman/client/img/wall.png"))));
	}

	@Override
	public void visit(Box box) {
		if(!rendered.containsKey(box.getUuid()))
			rendered.put(box.getUuid(), new ImageViewPane(new ImageView(new Image("ch/heigvd/bomberman/client/img/box.png"))));
	}
	...
	public void visit(Bomb bomb) {
		if(!rendered.containsKey(bomb.getUuid()))
			rendered.put(bomb.getUuid(), new ImageViewPane(new ImageView(new javafx.scene.image.Image("ch/heigvd/bomberman/client/img/bomb.png"))));
	}

	@Override
	public void visit(Bomberman bomberman) {
		if(!rendered.containsKey(bomberman.getUuid()))
			rendered.put(bomberman.getUuid(), new ImageViewPane(new ImageView(new Image("ch/heigvd/bomberman/client/img/skins/" + bomberman.getSkin() + ".png"))));
	}
	...
	public void visit(HorizontalExplosion explosion) {
		if(!rendered.containsKey(explosion.getUuid()))
			rendered.put(explosion.getUuid(), new ImageViewPane(new ImageView(new javafx.scene.image.Image("ch/heigvd/bomberman/client/img/explosion/explosionH.png"))));
	}
	...
	public void visit(CentralExplosion explosion) {
		if(!rendered.containsKey(explosion.getUuid()))
			rendered.put(explosion.getUuid(), new ImageViewPane(new ImageView(new javafx.scene.image.Image("ch/heigvd/bomberman/client/img/explosion/explosionC.png"))));
	}
